...
import { useStartTrial, useSubscriptionPlans } from "../api";
    ...
    <Screen padded={false} style={styles.container}>
      ...
      <ScrollView
        contentContainerStyle={[
          styles.scroll,
          { paddingBottom: insets.bottom + 120, paddingHorizontal: spacing.xxl },
        ]}
...
{/* ── Pro Features card ── */}
      ...
      <View
        style={[
          styles.ctaWrap,
          { paddingBottom: insets.bottom + spacing.lg, backgroundColor: colors.background },
        ]}
      >
        <TouchableOpacity
        ...
        >
          <Text style={styles.trialBtnText}>
            {startTrial.isPending ? "Starting..." : `Start ${TRIAL_DURATION_LABEL}`}
          </Text>
        </TouchableOpacity>
