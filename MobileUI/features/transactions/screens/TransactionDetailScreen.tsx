...
import { useDeleteTransaction, useTransaction, useUpdateTransaction } from "../api";
  ...
  if (isLoading) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <ScreenLoading label="Loading transaction" />
      </View>
    );
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScreenHeader
        ...
        onBack={editMode ? handleCancelEdit : () => router.replace("/(tabs)")}
        rightAction={
          !editMode ? (
