...
public class GetUserSubscriptionQueryHandler : IRequestHandler<GetUserSubscriptionQuery, UserSubscriptionDto>
{
    ...
    public GetUserSubscriptionQueryHandler(IApplicationDbContext db, ICurrentUserService currentUser)
    {
        _db = db;
        _currentUser = currentUser;
    }

    public async Task<UserSubscriptionDto> Handle(GetUserSubscriptionQuery request, CancellationToken cancellationToken)
    {
